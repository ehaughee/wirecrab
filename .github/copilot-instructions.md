...
8. When asked to commit changes, refer to previous commit messages for style and format. Always inspect the outstanding changes before committing to ensure accuracy of the description.
